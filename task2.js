var carsData=
    ...
    (function() {
      ...
      const x = d3.scaleBand()
        .domain(carsData.map(d => d.Manufacturer))
        .range([margin.left, width - margin.right])
        .padding(0.1);
    
      const y = d3.scaleLinear()
        .domain([0, d3.max(carsData, d => d.MPG)]).nice()
      ...
      const uniqueManufacturers = Array.from(new Set(carsData.map(d => d.Manufacturer)));
      ...
      legend.selectAll(".legend-item")
        ...
        .html(d => `<div class="legend-color" style="background-color: ${colorScale(d)};"></div>
          <div>${d}</div>`);
      ...
      carsData.forEach(d => {
          if (d.MPG !== null) {
            svg.append("text")
              ...
              .attr("x", x(d.Manufacturer) + x.bandwidth() / 2)
              .attr("y", y(d.MPG) - 5)
              .attr("text-anchor", "middle")
              .attr("fill", "#fff")
              .text(d.MPG.toFixed(2));
          }
        });
      ...
      svg.append("g")
        ...
        .on("mouseover", function (event, d) {
          ...
          tooltip.transition()
            .duration(200)
            .style("opacity", .9);
          tooltip.html("Manufacturer: " + d.Manufacturer + "<br/>" + "Avg MPG: " + d.MPG.toFixed(2))
