var carsData = [
    ...
    x.domain([0, d3.max(carsData, function (d) { return +d.Horsepower; })]);
    y.domain([0, d3.max(carsData, function (d) { return +d.MPG; })]);
    ...
    svg.selectAll(".dot")
        ...
        .on("mouseover", function (event, d) {
            ...
            tooltip.transition()
                .duration(200)
                .style("opacity", .9);
            tooltip.html("Car: " + d.Car + "<br/>" + "MPG: " + d.MPG + "<br/>" + "Horsepower: " + d.Horsepower)
    ...
    function zoomed(event) {
        ...
        var zoomOutButton = svg.select(".zoom-out-button");
        if (!zoomOutButton.empty()) {
