...
function calculateBoxPlotStatistics(data) {
    var statistics = {};
    data.forEach(function(d) {
        if (!statistics[d.Cylinders]) {
            statistics[d.Cylinders] = [];
        }
        statistics[d.Cylinders].push(+d.MPG);
    });

    var boxPlotData = [];
    Object.keys(statistics).forEach(function(key) {
        var sortedValues = statistics[key].sort(d3.ascending);
...
function drawBoxPlot(data) {
    ...
    var x = d3.scaleBand()
        .range([0, width])
        .padding(0.1)
        .domain(data.map(function(d) { return d.Cylinders; }));
    ...
    svg.selectAll(".box")
        ...
        .attr("fill", function(d) { return colors(d.Cylinders); }) 
        .on("click", function(event, d) {
            
            filterByCylinders(d.Cylinders);
        })
        ...
        .on("mouseover", function(event, d) {
            ...
            tooltip.transition()
                .duration(200)
                .style("opacity", .9);
            tooltip.html("Cylinders: " + d.Cylinders + "<br/>" +
                         "Mean: " + d3.mean(d.values).toFixed(2) + "<br/>" +
                         "Median: " + d.median + "<br/>" +
                         "Q1: " + d.q1 + "<br/>" +
                         "Q3: " + d.q3)
    ...
    svg.selectAll(".median-line")
        ...
        .attr("x1", function(d) { return x(d.Cylinders) + x.bandwidth() / 4; })
        .attr("y1", function(d) { return y(d.median); })
        .attr("x2", function(d) { return x(d.Cylinders) + x.bandwidth() * 3 / 4; })
    ...
    var legend = svg.selectAll(".legend")
        .data(data.map(function(d) { return d.Cylinders; }))
        .enter().append("g")
        .attr("class", "legend")
    ...
    legend.append("text")
        ...
        .text(function(d) { return "Cylinders: " + d; });
...
function filterByCylinders(cylinders) {
    ...
    var filteredData = carsData.filter(function(d) {
        return d.Cylinders === cylinders;
    });
    
    var filteredBoxPlotData = calculateBoxPlotStatistics(filteredData);
    drawBoxPlot(filteredBoxPlotData);
}
...
var boxPlotData = calculateBoxPlotStatistics(carsData);
drawBoxPlot(boxPlotData);
